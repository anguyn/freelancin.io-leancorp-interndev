      ...
      en: {
        translation: {
          ...
          journey: {
            ...
            name2: 'improve communication with customers and <br /> clients',
            name3: 'average improvement <br /> in team efficiency',
            learn: 'Learn more ',
          },
          features: {
            title: 'Our Features',
            header:
              'Unleash your creativety with a visual collaboration <br /> plattorm that enables effective ideation',
          ...
          projects: {
            title: 'Our Projects',
            header: 'We have been providing great <br /> flooring solutions service.',
            tab1: 'All',
            tab2: 'Websites',
            tab3: 'Social Media',
            tab4: 'UI/UX',
      ...
      vi: {
        translation: {
          ...
          features: {
            ...
            header:
              'Phát huy sự sáng tạo của bạn với một <br /> nền tảng hợp tác trực quan cho phép ý tưởng hiệu quả',
            feature1: 'Chọn một dịch vụ',
          ...
          services: {
            title: 'Dịch vụ',
            header:
              'Đội ngũ hỗ trợ của chúng tôi sẽ nhận được sự hỗ trợ từ các gợi ý được cung cấp bởi trí tuệ nhân tạo, <br /> giúp xử lý yêu cầu hỗ trợ nhanh chóng hơn bao giờ hết.',
          ...
          projects: {
            ...
            header: 'Chúng tôi đã cung cấp giải pháp sàn <br /> giao dịch sàn chất lượng tốt.',
            tab1: 'Tất cả',
            tab2: 'Trang web',
            tab3: 'Mạng xã hội',
